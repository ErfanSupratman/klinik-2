      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li class="">
            ...
            <span class="details">Data Obat Tersedia</span>
            </a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header clearfix ">
                ...
                <h4 class="p-b-5"><span class="semi-bold">Tambah</span> Barang</h4>
              </div>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Daftar Obat</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-6">
                    <button class="btn btn-primary btn-cons" id="registpasien">Tambah Barang</button>
                  </div>
                </div>
                <div class="pull-right">
                  <div class="col-xs-12">
